...
example_game_world::example_game_world() noexcept : game_world() {
  // create entities
...
void example_game_world::dispatch_event(SDL_Event* event) noexcept {
  game_world::dispatch_event(event);
